...
- **Sample Data**: Examples of sample data that can be used with the package.
- **CarbR Function "aspect and slope"**: Explanation of the main function in the package.
- **Example Usage**: Demonstrations and code snippets for using the CarbR package.
